...
gallery_strip:
  ...
  images:
    - src: 'carisma1.png'
      alt: 'Motrat duke dëgjuar më të vegjlit'
    - src: 'carisma2.png'
      alt: 'Momente shërbimi dhe afërsie'
    - src: 'carisma3.png'
      alt: 'Lutje dhe jetë vëllazërore'
    - src: 'carisma4.png'
      alt: 'Mision ndër të varfrit'

testimonials:
  enabled: true
  background_image: 'madre.jpg'
  label: 'DËSHMI'
  title: 'Një karizmë që bëhet jetë'
  subtitle: 'Zëri i atyre që përditë përjetojnë amësinë shpirtërore të Bijave të Rosazit.'
  items:
    - quote: >
        Kam takuar Motrat Françeskane Misionare të Susës në një moment të
        lodhjes së madhe. Prania e tyre diskrete, por e vazhdueshme, më bëri të
        rizbulloj dinjitetin që mendoja se kisha humbur. Me gjeste të thjeshta,
        një vështrim të kujdesshëm dhe shumë durim, ndjeva se Zoti nuk kishte
        reshtur së kujdesuri për mua.
      name: 'Anna'
